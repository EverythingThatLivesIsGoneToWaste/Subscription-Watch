        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Color = table.Column<long>(type: "bigint", nullable: false, defaultValue: 4289581738L)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultRemindDaysBefore = table.Column<int>(type: "integer", nullable: false, defaultValue: 3),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultCurrency = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActualCurrency = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    ...
                    RemindDaysBefore = table.Column<int>(type: "integer", nullable: false, defaultValue: 3),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reminders_UserSubscriptions_UserSubscriptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reminders_UserSubscriptionId",
                table: "Reminders",
